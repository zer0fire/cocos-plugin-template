...
declare namespace Editor {
  ...
  export class Worker {
    constructor(
      name: string,
      options?: { workerType: "renderer" | "main"; url: string }
    );
    close();
    dispose();
  ...
  export class Dialog {
    static openFile(...args: any[]): -1 | string[];
  ...
  export class Ipc {
    ...
    static sendToAll(...args: any[]): void;
    static sendToMain(
      message: string,
      ...args: any[]
    ): // callback?: Function,
  ...
  export class MainMenu {
    ...
    static set(
      ...
      options:
        | object
        | { icon: any; enabled: boolean; visible: boolean; checked: boolean }
    ): void;
  ...
  export class Window {
    constructor(
      name: string,
      options?: {
        windowType?: "dockable" | "float" | "fixed-size" | "quick";
        save?: boolean;
      }
    );

    static nativeWin: Electron.BrowserWindow;
    nativeWin: Electron.BrowserWindow;
  ...
  export class Selection {
    ...
    static curSelection(type: string): string[];
  ...
  export class Undo {
    ...
    static register(
      id: string,
      cdm: { undo: Function; redo: Function; dirty: Function }
    );
    static Command: {
      undo: Function;
      redo: Function;
  ...
  export class assetdb {
    static import(
      url: string[],
      toPath: string,
      callback: AssetdbCallBack
    ): void;
    static create(url: string, data: any, callBack: AssetdbCallBack): void;
    static createOrSave(
      url: string,
      data: any,
      callBack: AssetdbCallBack
    ): void;
    static delete(url: string, callback: AssetdbCallBack): void;
    ...
    /**
     *
     * @description mainProcess可用
     */
    static uuidToUrl(uuid: string): string;
...
declare namespace Editor.remote {
  export const Panel = Editor.Panel;

  export const Window = Editor.Window;
  export class assetdb {
    static import(
      url: string[],
      toPath: string,
...
declare namespace Editor.Scene {
  export function callSceneScript(packageName: string, message: string): void;
  export function callSceneScript(
    packageName: string,
    ...args: any[],
    callback: (data: any) => void
  ): void;
  export function callSceneScript(packageName: string, ...args: any[]): void;
}
declare namespace Editor.remote.Scene {
  export function callSceneScript(packageName: string, message: string): void;
  export function callSceneScript(
    packageName: string,
    message: string,
...
declare namespace Editor.remote.assetdb {
  ...
  export function refresh(url, callback?: AssetdbCallBack);
...
// import { UuidUtils } from "./EditorPublic";
// declare namespace Editor.Utils {
//   export { UuidUtils };
// }
